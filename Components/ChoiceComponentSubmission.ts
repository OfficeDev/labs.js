...
module Labs.Components {
     ...
     */
    export class ChoiceComponentSubmission {
        /**
         * The answer associated with the submission
         */
        answer: ChoiceComponentAnswer;

        /**
         * The result of the submission
         */
        result: ChoiceComponentResult;
         ...
         */
        constructor(answer: ChoiceComponentAnswer, result: ChoiceComponentResult, time: number) {
            this.answer = answer;
            this.result = result;
            this.time = time;
        }
